...
Plugin URI: https://www.freeplugin.org/
...
?>
	...
	<div style="float:right; width:25%;">
		...
		echo atl_box_content('A Free Plugin by PMI Servizi', '
			<a target="_blank" href="https://www.pmiservizi.it" title="PMI Servizi Web Agency">
		...
		')
			...
			<a href="http://www.pmiservizi.it" target="_blank" title="PMI Servizi - Contact us">website form</a>.
...
function atl_feed()
{
	$feedurl = 'http://www.pmiservizi.it/feed/';
	$select = 8;
